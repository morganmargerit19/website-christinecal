...
export const ui: Record<Locale, UIDict> = {
  fr: {
    ...
    hero: {
      ...
      portalBaseline: 'Une galactique venue du futur…',
      portalEyebrow: 'Éveil à sa multidimensionnalité',
    },
    paths: {
  ...
  en: {
    ...
    hero: {
      ...
      scrollHint: 'Discover',
      portalBaseline: 'A galactic soul from the future…',
      portalEyebrow: 'Awakening to your multidimensionality',
    },
    paths: {
  ...
  pl: {
    ...
    hero: {
      ...
      scrollHint: 'Odkryj',
      portalBaseline: 'Istota galaktyczna z przyszłości…',
      portalEyebrow: 'Przebudzenie do swojej wielowymiarowości',
    },
    paths: {
      heading: 'Dwie bramy',
  ...
  es: {
    ...
    hero: {
      ...
      portalBaseline: 'Una galáctica venida del futuro…',
      portalEyebrow: 'Despertar a tu multidimensionalidad',
    },
    paths: {
  ...
  it: {
    ...
    hero: {
      ...
      scrollHint: 'Scopri',
      portalBaseline: 'Una galattica venuta dal futuro…',
      portalEyebrow: 'Risveglio alla tua multidimensionalità',
    },
    paths: {
