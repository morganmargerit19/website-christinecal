...
<MediaDuo float images={[
  { src: "/images/wp/telos-revelations-de-la-nouvelle-lemurie.jpg", alt: "« Révélations de la Nouvelle Lémurie » — Aurelia Louise Jones (Tome 1)", caption: "TELOS — Révélations de la Nouvelle Lémurie" },
  { src: "/images/wp/messages-from-hollow-earth.jpg", alt: "« Messages from the Hollow Earth » — Dianne Robbins", caption: "Messages from the Hollow Earth" }
]} />
